...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--video_path",
        type=str,
        default="/home/jushen/datas/code/GMR/data/video/test.mp4",
    )
    ...
    while i < len(data_frames):
        ...
        # )
        #input("Press Enter to continue to the next frame...")  # Wait for user input before proceeding to the next frame
        i += 1
